@echo off
REM Test script for RTMP reconnect functionality on Windows
REM This script demonstrates how to use the new reconnect options

echo RTMP Reconnect Test Script for Windows
echo =====================================
echo.

REM Test 1: Basic reconnect
...
REM Test 3: Aggressive reconnect for unstable connections
